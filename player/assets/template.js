...
<body>
    <ul>
       ...
       <li>
          <a href="http://127.0.0.1:3000/"> inicio </a>
       </li>
    </ul>

    <object data-src="%URL%" type="text/aplication" class="contenedor" id="course-container"></object>
...
{/* <iframe id="course-container" data-src="%URL%" ></iframe>
*/}
